...
if (user != null) {
    ...
    // Récupération des paramètres d'erreur et de succès
...
<head>
    ...
    <title>Connexion - Portefeuille Électronique</title>
...
<body>
    <div class="form-container">
        ...
        <p class="text-center">Pas encore inscrit ? <a href="register.jsp">Inscrivez-vous ici</a></p>
    </div>
